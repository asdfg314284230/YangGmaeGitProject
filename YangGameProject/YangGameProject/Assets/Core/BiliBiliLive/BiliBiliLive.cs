...
namespace Liluo.BiliBiliLive
{
    public static class BiliBiliLive
    {
        ...
        public static async Task<Texture2D> GetHeadTexture(string userID) => await BiliBiliLiveHeadImage.GetHeadTexture(userID);
        ...
        /// <param name="userID">用户ID</param>
        /// <returns>头像链接</returns>
        public static async Task<Sprite> GetHeadSprite(string userID) => await BiliBiliLiveHeadImage.GetHeadSprite(userID);

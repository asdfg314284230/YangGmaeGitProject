...
namespace Net
{
    public class ByteBuffer
    {
        ...
        public void WriteFloat(float v)
        {
            ...
            Array.Reverse(temp);
            writer.Write(System.BitConverter.ToSingle(temp, 0));
        }
        ...
        public void WriteDouble(double v)
        {
            byte[] temp = System.BitConverter.GetBytes(v);
            Array.Reverse(temp);
            writer.Write(System.BitConverter.ToDouble(temp, 0));
        }
        ...
        {
            byte[] temp = System.BitConverter.GetBytes(reader.ReadSingle());
            Array.Reverse(temp);
        ...
        {
            byte[] temp = System.BitConverter.GetBytes(reader.ReadDouble());
            Array.Reverse(temp);
        ...
        {
            //Debug.Log("ReadBytes with  len" + len);
            return reader.ReadBytes(len);
        }
